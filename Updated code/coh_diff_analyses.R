...
setwd('/Volumes/SAMSUNG/Neural_entrainment_to_native_and_foreign_speech/Epoched data/Data analysis/ITPC')

library(car)
idatalang <- read.csv("idata_coh_diff.csv")
datalang_delta <- read.csv("coh_diff_delta.csv")
...
itc_delta_ttests=read.csv("coh_diff_delta_ttests.csv")
print(pairwise.t.test(itc_delta_ttests$CoherenceDifference, itc_delta_ttests$Condition, p.adj = "none", paired = TRUE))

datalang_theta <- read.csv("coh_diff_theta.csv")
...
itc_theta_ttests=read.csv("coh_diff_theta_ttests.csv")
print(pairwise.t.test(itc_theta_ttests$CoherenceDifference, itc_theta_ttests$Condition, p.adj = "none", paired = TRUE))

datalang_alpha <- read.csv("coh_diff_alpha.csv")
...
itc_alpha_ttests=read.csv("coh_diff_alpha_ttests.csv")
print(pairwise.t.test(itc_alpha_ttests$CoherenceDifference, itc_alpha_ttests$Condition, p.adj = "none", paired = TRUE))
