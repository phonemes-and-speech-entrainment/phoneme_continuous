...
EEG = pop_loadset('filename',files(i).name,'filepath','/Volumes/SAMSUNG/Neural_entrainment_to_native_and_foreign_speech/Sets with edited events/');
EEG.setname=token;
...
EEG = eeg_checkset( EEG );
%}
EEG = pop_saveset( EEG, 'filename',strcat(token,' baseline epochs.set'),'filepath','/Volumes/SAMSUNG/Neural_entrainment_to_native_and_foreign_speech/Sets with edited events/Baseline epochs/');
EEG = eeg_checkset( EEG );
end
